...
namespace Assets.FantasyHeroes.Scripts
{
    ...
    public class Character : MonoBehaviour
    {
        ...
        {
            var weaponChanged = PrimaryMeleeWeaponRenderer.sprite != PrimaryMeleeWeapon || SecondaryMeleeWeaponRenderer.sprite != SecondaryMeleeWeapon;
            ...
            if (weaponChanged)
            {
                foreach (var weaponRenderer in new[] { PrimaryMeleeWeaponRenderer, SecondaryMeleeWeaponRenderer })
                {
                    weaponRenderer.GetComponentInChildren<MeleeWeaponTrail>().Build();
                }
            }
        }
